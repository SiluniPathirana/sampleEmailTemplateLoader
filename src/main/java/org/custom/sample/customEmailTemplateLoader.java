...
public class customEmailTemplateLoader extends AbstractAxis2ConfigurationContextObserver {

    private static final Log log = LogFactory.getLog(customEmailTemplateLoader.class);

    @Override
    public void createdConfigurationContext(ConfigurationContext configContext) {


        log.info("-------------------------Tenant Loading ---------------------");
